...
function(i) {
    ...
    t.prototype._reset = function() {
        ...
        t.prototype.initMenu = function() {
            var t, e = this;
            this._reset(),
                i(document).on("click", ".button-menu-mobile",
                    function(t) {
                        t.preventDefault(),
            ...
            i(".side-nav").length && (t = i(".side-nav li .collapse"), i(".side-nav li [data-bs-toggle='collapse']").on("click",
                function(t) {
                    return ! 1
                }), t.on({
            ...
            a.forEach(function(a) {
                a.addEventListener("click",
                    ...
                    a.addEventListener("hide.bs.dropdown",
                        function(t) {
                            o && (t.preventDefault(), t.stopPropagation(), o = !1)
                        }),
                    a.addEventListener("show.bs.dropdown",
                        function(t) {
...
function(a) {
    ...
    t.prototype._selectOptionsFromConfig = function() {
        ...
        t.prototype.init = function() {
            var e = this;
            a(document).on("click", ".end-bar-toggle",
                function() {
...
function(i) {
    ...
    t.prototype.init = function() {
        var o = this;
        i(document).on("click", this.$portletCloser,
            function(t) {
                t.preventDefault();
            ...
            i(document).on("click", this.$portletRefresher,
                function(t) {
                    t.preventDefault();
                    var e = i(this).closest(o.$portletIdentifier);
...
function(a) {
    ...
    t.prototype.activateDefaultSidebarTheme = function() {
        ...
        t.prototype.init = function() {
            ...
            e && document.getElementById("selectToastPlacement").addEventListener("change",
                function() {
